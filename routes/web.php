...
use App\Http\Livewire\ProductAttribute;
...
Route::group(['prefix' => LaravelLocalization::setLocale(), 'middleware' => ['localeSessionRedirect', 'localizationRedirect', 'localeViewPath']], function () {
    ...
    Route::get('/productDetails/{product_id}/{color?}/{size?}', [FrontEndController::class, 'productDetails'])->name('productDetails');
    ...
    Route::get('/about-us', function () {
        ...
        return view('front_end_inners.about_us')->with('seo_operation',$seo_operation)->with('photos', $photos)->with('about_us', $about_us);
    })->name('aboutUs');
    ...
    Route::prefix('customer')->name('customer.')->group(function () {
        ...
        Route::group(['middleware' => ['checkAuth']], function () {
            ...
            Route::post('/wishlist', [CustomerController::class, 'wishlist'])->name('wishlist')->middleware('auth:customer');
