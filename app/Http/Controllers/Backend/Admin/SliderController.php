...
use App\Http\Requests\Backend\Sliders\StoreSliderFormRequest;
use App\Http\Requests\Backend\Sliders\UpdateSliderFormRequest;
    ...
    public function store(StoreSliderFormRequest $request, Route $route)
    {
        try {
            ...
            if (isset($request->image)) {
                ...
                $upload_location = 'images/sliders/';
