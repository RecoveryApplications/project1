            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div id="data-step1" class="account-content" data-temp="tabdata">
                        ...
                        <div class="p-4 m-0" id="createWithdrawalRequest" style="background: rgba(0, 0, 0, 0.089)">
                            <div class="row mb-30">
                            ...
                            <div class="row mb-30">
                                ...
                                <div class="col-12">
                                    <div class="cart-total-table address-box commun-table">
                                        <form action="{{ route('customer.request_order.store', 'western') }}"
                                                        ...
                                                        <fieldset>
                                                            <select id="country" class="option-drop" name="country_id"
                                                                ...
                                                                @foreach ($countries as $country)
                                                                    <option @selected($country->id == auth('customer')->user()->country_id) )
                                                                        value="{{ $country->id }}">
                                                                        {{ $country->name_en }}
                                                                    </option>
                                                                @endforeach
