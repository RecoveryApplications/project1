                            ...
                            <table class="table">
                                ...
                                <tbody id="table-compare">
                                    ...
                                    <tr>
                                        ...
                                        <td class="item-row"><img src="{{ asset('front_end_style/assets/images/pro3/1.jpg')}}" alt=""
                                        ...
                                        <td class="item-row"><img src="{{ asset('front_end_style/assets/images/pro3/33.jpg')}}" alt=""
                                                class="featured-image">
                                            <div class="product-price product_price"><strong>On Sale:
                                                </strong><span>$89,00</span></div>
                                            <form class="variants clearfix">
                                        ...
                                        <td class="item-row"><img src="{{ asset('front_end_style/assets/images/pro3/35.jpg')}}" alt=""
                                                class="featured-image">
                                        ...
                                        <td class="item-row"><img src="{{ asset('front_end_style/assets/images/pro3/27.jpg')}}" alt=""
                                                class="featured-image">
                                            <div class="product-price product_price"><strong>On Sale:
                                                </strong><span>$89,00</span></div>
                                            <form class="variants clearfix">
