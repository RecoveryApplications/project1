                                ...
                                <form action="order-overview.html" class="main-form full">
                                    <div class="mb-20 row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-box">
                                                ...
                                                <span>Please include landmark (e.g : Opposite Bank) as the carrier service
                                                    may find it easier to locate your address.</span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-box select-dropdown">
                                                <fieldset>
                                                    <select name="shippingCountryId" class="option-drop"
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-box select-dropdown">
                                                <fieldset>
                                                    <select name="shippingstateId" class="option-drop"
                                                        id="shippingstateid">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="check-box">
                                                <span>
                                                    <input type="checkbox" class="checkbox" id="chk-billing-address"
                                                        name="chk-billing-address">
                                                    <label for="chk-billing-address">Use my delivery address as my billing
                                                        address</label>
                                                </span>
                                            </div>
                                        </div>
