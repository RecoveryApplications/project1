        ...
        <div class="content">
            ...
            {{-- ============================================== --}}
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="page-header-left">
                                        <h3>Update Main Category Information
                                ...
                                <div class="col-lg-6">
                                    <ol class="breadcrumb pull-right">
                                        ...
                                        <li class="breadcrumb-item active">Update Main Category Information</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row product-adding">
                        ...
                        <div class="col-xl-12">
                            <form action="{{ route('super_admin.mainCategories-update', [$mainCategory->id]) }}" method="POST" enctype="multipart/form-data"
                                    ...
                                    <div class="form-group mb-3 row">
                                        ...
                                        <div class="col-xl-8 col-sm-7">
                                            <input name="name_ar" class="form-control @error('name_ar') is-invalid @enderror" id="validationCustom01"
                                                type="text"  value="{{ isset($mainCategory->name_ar) ? $mainCategory->name_ar : null }}" placeholder="Name AR" >
                                        </div>
                                    ...
                                    <div class="form-group mb-3 row">
                                        ...
                                        <div class="col-xl-8 col-sm-7">
                                            <input name="name_en" class="form-control @error('name_en') is-invalid @enderror" id="validationCustom01"
                                                type="text"  value="{{ isset($mainCategory->name_en) ? $mainCategory->name_en : null }}" placeholder="Name EN" >
                                        </div>
                                        <div class="valid-feedback">Looks good!</div>
                                    </div>
                                    <div class="form-group mb-3 row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col-xl-8 col-sm-7">
                                                <input name="seo_title_ar" class="form-control @error('seo_title_ar') is-invalid @enderror" id="validationCustom01"
                                                    type="text"  value="{{ $mainCategory->seo_title_ar }}" placeholder="seo_title_ar" >
                                            </div>
                                            <div class="valid-feedback">Looks good!</div>
                                        </div>
                                            {{-- seo title En --}}
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col-xl-8 col-sm-7">
                                                <input name="seo_title_en" class="form-control @error('seo_title_en') is-invalid @enderror" id="validationCustom01"
                                                    type="text"  value="{{ $mainCategory->seo_title_en }}" placeholder="seo_title_en" >
                                            </div>
                                            <div class="valid-feedback">Looks good!</div>
                                        </div>
                                          {{-- Meta Desc AR--}}
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col-xl-8 col-sm-7">
                                                    ...
                                                    rows="5"class="form-control ">{{ $mainCategory->meta_desc_ar }}</textarea>
                                            </div>
                                            <div class="valid-feedback">Looks good!</div>
                                        </div>
                                            {{-- Meta Desc EN--}}
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col-xl-8 col-sm-7">
                                                    ...
                                                    rows="5"class="form-control ">{{ $mainCategory->meta_desc_en }}</textarea>
                                            </div>
                                            <div class="valid-feedback">Looks good!</div>
                                        </div>
                                            {{-- SEO Meta data AR --}}
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col-xl-8 col-sm-7">
                                                    ...
                                                    rows="5"class="form-control ">{{ $mainCategory->keywords_ar }}</textarea>
                                            </div>
                                            <div class="valid-feedback">Looks good!</div>
                                        </div>
                                            {{-- SEO Meta data EN --}}
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col-xl-8 col-sm-7">
                                                    ...
                                                    rows="5"class="form-control ">{{ $mainCategory->keywords_en }}</textarea>
                                            </div>
                                            <div class="valid-feedback">Looks good!</div>
