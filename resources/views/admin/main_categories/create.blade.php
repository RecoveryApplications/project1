        ...
        <div class="content">
            ...
            {{-- ============================================== --}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <ol class="breadcrumb pull-right">
                                        ...
                                        <li class="breadcrumb-item active">Add New Main Category</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row product-adding">
                        ...
                        <div class="col-xl-12">
                            <form action="{{ route('super_admin.mainCategories-store') }}" method="POST" enctype="multipart/form-data"
                                    ...
                                    <div class="form-group mb-3 row">
                                        ...
                                        <div class="col-xl-8 col-sm-7">
                                            <input name="name_ar" class="form-control @error('name_ar') is-invalid @enderror" id="validationCustom01"
                                                type="text"  value="{{ old('name_ar') }}" placeholder="Name AR" required="">
                                        </div>
                                    ...
                                    <div class="form-group mb-3 row">
                                        ...
                                        <div class="col-xl-8 col-sm-7">
                                            <input name="name_en" class="form-control @error('name_en') is-invalid @enderror" id="validationCustom01"
                                                type="text"  value="{{ old('name_en') }}" placeholder="Name EN" required="">
                                        </div>
                                        <div class="valid-feedback">Looks good!</div>
                                    </div>
                                    <div class="form-group mb-3 row">
