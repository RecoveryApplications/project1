                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <ol class="breadcrumb pull-right">
                                ...
                                <li class="breadcrumb-item active">All Main Categories</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                     <div class="card-header">
                        <a href="{{ route('super_admin.mainCategories-create') }}" class="btn btn-primary add-row mt-md-0 mt-2">Add New</a>
                        <a href="{{ route('super_admin.mainCategories-showSoftDelete') }}" class="btn btn-danger add-row mt-md-0 mt-2">Archive </a>
                        </div>
                            ...
                            <tbody>
                                ...
                                @if ($mainCategories->count() > 0)
                                    ...
                                    <tr>
                                        ...
                                        @endif
                                        <td>{{ isset($category->created_at) ? $category->created_at : "<span style='color:red;'>Undefined</span>" }}</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('super_admin.mainCategories-edit', [$category->id]) }}"class=" btn  btn-success">
                                                <i class="fa fa-edit" title="Edit"></i>
                                            </a>



                                            <a href="{{ route('super_admin.mainCategories-softDelete', [$category->id]) }}"class=" btn  btn-danger">
                                                <i class="fa fa-close" title="soft Delete"></i>
                                            </a>
                                            <a href="{{ route('super_admin.mainCategories-activeInactiveSingle', [$category->id]) }}" title="Active / Inactive" class=" btn  btn-warning"><i class="fa fa-stop" aria-hidden="true"></i></a>
