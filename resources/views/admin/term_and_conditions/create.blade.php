        ...
        <div class="content">
            ...
            {{-- ============================================== --}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <ol class="breadcrumb pull-right">
                                        ...
                                        <li class="breadcrumb-item active">Add New Term And Condition</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row product-adding">
                        ...
                        <div class="col-xl-12">
                            <form action="{{ route('super_admin.term_and_conditions-store') }}" method="POST" enctype="multipart/form-data"
                                    ...
                                    <div class="form-group mb-3 row">
                                        ...
                                        <div class="col-xl-8 col-sm-7">
                                            <input name="term_and_condition_title_en" class="form-control @error('term_and_condition_title_en') is-invalid @enderror" id="validationCustom01"
                                                type="text"  value="{{ old('term_and_condition_title_en') }}" placeholder="Title AR" required="">
                                        </div>
                                    ...
                                    <div class="form-group mb-3 row">
                                        ...
                                        <div class="col-xl-8 col-sm-7 description-sm">
                                            <textarea id="editor1" name="term_and_condition_des_en" cols="10"
                                                rows="5">{{ old('term_and_condition_des_en') }}</textarea>
                                        </div>
                                        <div class="valid-feedback">Looks good!</div>
                                    </div>
