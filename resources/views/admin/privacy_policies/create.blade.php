        ...
        <div class="content">
            ...
            {{-- ============================================== --}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <ol class="breadcrumb pull-right">
                                        ...
                                        <li class="breadcrumb-item active">Add New Privacy Policy</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row product-adding">
                        ...
                        <div class="col-xl-12">
                            <form action="{{ route('super_admin.privacy_policies-store') }}" method="POST" enctype="multipart/form-data"
                                    ...
                                    <div class="form-group mb-3 row">
                                        ...
                                        <div class="col-xl-8 col-sm-7">
                                            <input name="privacy_policy_title_en" class="form-control @error('privacy_policy_title_en') is-invalid @enderror" id="validationCustom01"
                                                type="text"  value="{{ old('privacy_policy_title_en') }}" placeholder="Title AR" required="">
                                        </div>
                                    ...
                                    <div class="form-group mb-3 row">
                                        ...
                                        <div class="col-xl-8 col-sm-7 description-sm">
                                            <textarea id="editor1" name="privacy_policy_des_en" cols="10"
                                                rows="5">{{ old('privacy_policy_des_en') }}</textarea>
                                        </div>
                                        <div class="valid-feedback">Looks good!</div>
                                    </div>
