    ...
    <div class="page-sidebar">
        ...
        <div class="sidebar custom-scrollbar">
            ...
            <div class="sidebar-user">
                <img class="img-40" src="{{ asset(auth()->user()->profile_photo_path ?? 'dashboard_files/assets/images/dashboard/user3.jpg')}}" alt="#">
                <div>
                    <h6 class="f-14"> {{ isset(auth()->user()->name_en) ? auth()->user()->name_en : 'Undefined' }}</h6>
...
{{--
                ...
                <li>
                    <a class="sidebar-header" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
