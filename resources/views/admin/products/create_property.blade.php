                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card card-default">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('super_admin.properties-store', $product->id) }}"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="input-group">
                                                            <select name="on_sale_price_status"
                                                                ...
                                                                <option value="1"
                                                                    @if (old('on_sale_price_status') == '1') selected @endif>Active
                                                                </option>
                                                                <option value="2"
