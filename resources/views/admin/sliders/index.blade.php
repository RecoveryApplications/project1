            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('super_admin.sliders-create') }}" class="mt-2 btn btn-primary add-row mt-md-0">Add
                            New</a>
                        <a href="{{ route('super_admin.sliders-showSoftDelete') }}"
                            class="mt-2 btn btn-danger add-row mt-md-0">Archive </a>
                    </div>
                                    ...
                                    @foreach ($sliders as $index => $slider)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a
                                                    href="{{ route('super_admin.sliders-edit', [$slider->id]) }}"class=" btn btn-success">
                                                ...
                                                <a
                                                    href="{{ route('super_admin.sliders-softDelete', [$slider->id]) }}"class=" btn btn-danger">
                                                    <i class="fa fa-close" title="soft Delete"></i>
                                                </a>
                                                <a href="{{ route('super_admin.sliders-activeInactiveSingle', [$slider->id]) }}"
                                                    title="Active / Inactive" class=" btn btn-warning"><i
                                                        class="fa fa-stop" aria-hidden="true"></i></a>

                                                <a
                                                    href="{{ route('super_admin.sliders-destroy', [$slider->id]) }}"class="btn btn-primary">
