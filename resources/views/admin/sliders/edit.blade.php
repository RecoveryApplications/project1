        ...
        <div class="content">
            ...
            {{-- ============================================== --}}
                    ...
                    <div class="row product-adding">
                        ...
                        <div class="col-xl-12">
                            <form action="{{ route('super_admin.sliders-update', [$slider->id]) }}" method="POST" enctype="multipart/form-data"
                                    ...
                                    <div class="form-group mb-3 row">
                                        ...
                                        <div class="col-xl-8 col-sm-7">
                                            <input name="title_ar" class="form-control @error('title_ar') is-invalid @enderror" id="validationCustom01"
                                                type="text"  value="{{ isset($slider->title_ar) ? $slider->title_ar : null }}" placeholder="Title AR" required="">
                                        </div>
                                    ...
                                    <div class="form-group mb-3 row">
                                        ...
                                        <div class="col-xl-8 col-sm-7">
                                            <input name="title_en" class="form-control @error('title_en') is-invalid @enderror" id="validationCustom01"
                                                type="text"  value="{{ isset($slider->title_en) ? $slider->title_en : null }}" placeholder="Title EN" required="">
                                        </div>
                                        <div class="valid-feedback">Looks good!</div>
                                    </div>
                                    <div class="form-group mb-3 row">
                                ...
                                <div class="form">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-sm-7 description-sm">
                                            <textarea id="desc_ar" name="description_ar" cols="10"
                                                rows="5"class="form-control ">{{ isset($slider->description_ar) ? $slider->description_ar : null }}</textarea>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-sm-4">Slider Details EN :</label>
                                        <div class="col-xl-8 col-sm-7 description-sm">
                                            <textarea id="desc_en" name="description_en" cols="10"
                                                rows="5"class="form-control ">{{ isset($slider->description_en) ? $slider->description_en : null }}</textarea>
                                        </div>
