                                ...
                                <div class="form">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-sm-7 description-sm">
                                            <textarea id="desc_ar" name="description_ar" cols="105"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-sm-7 description-sm">
                                            <textarea id="desc_en" name="description_en" cols="105"
                                                rows="10"class="form-control ">{{ old('description_en') }}</textarea>
                                        </div>
